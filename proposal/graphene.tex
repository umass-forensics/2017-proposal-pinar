...
transaction contents are placed in the \textit{mempool}.
...
We make use of IBLTs~\cite{goodrich:2011}, which is an efficient data structure  for {\em set reconciliation} between two peers.  Like 
